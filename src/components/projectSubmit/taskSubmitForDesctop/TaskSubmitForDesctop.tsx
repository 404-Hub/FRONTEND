...
import { Paper, Box, Typography, Button, FormControlLabel, FormGroup, Checkbox, Tooltip, Grid } from '@mui/material';
import { useRouter } from 'next/navigation';
import { useState, useEffect, useCallback } from 'react';
import { TTaskSubmitProps } from '@/types/taskSubmit';
import { styled } from '@mui/material/styles';
import { TooltipProps, tooltipClasses } from '@mui/material/Tooltip';
import { PAGE_TITLE, GOOD, IS_ALL_READY, CANSEL, SUBMITING, textAfterSubmitClick } from '../textForTaskSubmit';
...
const TaskSubmitForDesctop = (props: TTaskSubmitProps) => {
  ...
  const CustomWidthTooltip = styled(({ className, ...styledProps }: TooltipProps) => (
    <Tooltip
      {...styledProps}
