...
import { Paper, Box, Typography, Button, FormControlLabel, FormGroup, Checkbox } from '@mui/material';
import { useRouter } from 'next/navigation';
import { useCallback } from 'react';
import { TTaskSubmitingProps } from '@/types/taskSubmit';
import { PAGE_TITLE, NO, YES, GOOD, IS_ALL_READY } from '../textForTaskSubmit';

const TaskSubmiting = (props: TTaskSubmitingProps) => {
  const { validation, submiting, conditions, handleChangeCondition, isValidCond } = props;
