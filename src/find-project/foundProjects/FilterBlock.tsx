    ...
    <Box >
      <Box sx={filtersStyles.filtersBox}>
        <Box sx={filtersStyles.filtersReset}>
          ...
          { filterExist ? <Button onClick={props.resetFilters} sx={[filtersStyles.button, filtersStyles.buttonReset]}>Сбросить</Button>
          : ''}
        </Box>
        ...
        <Box 
          ...
          >
            ...
            <RenderFilters showFilters={props.showFilters} handleChange={props.handleChange} allFilters={props.allFilters}></RenderFilters>
              
            <Box sx={filtersStyles.buttonBox}>
              <Button onClick={cancel} sx={[filtersStyles.button, filtersStyles.buttonCancel]} >Отмена</Button>
